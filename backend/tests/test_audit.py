"""Unit tests for HMAC-chained audit log integrity."""
...
def test_hmac_changes_with_timestamp():
    """Different timestamps must yield different HMAC digests."""
    h1 = _compute_hmac("GENESIS", "did:ethr:0xABC", "USER_LOGIN", "2026-04-15T10:00:00+00:00")
...
def test_chain_breaks_on_tamper():
    """Tampering with the previous HMAC must invalidate the chain link."""
