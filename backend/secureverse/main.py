"""SecureVerse FastAPI application entry point."""
...
from secureverse.auth.router import limiter, router as auth_router
...
app = FastAPI(title="SecureVerse Identity Layer", version="1.0.0", lifespan=lifespan)
...
async def health():
    ...
    return {"status": "ok", "service": "SecureVerse"}
